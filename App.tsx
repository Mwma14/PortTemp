  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-8">
        ...
        <button 
          onClick={onStart}
          className="bg-slate-800 w-[280px] md:w-[320px] z-40 h-[80px] md:h-[100px] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block"
        >
